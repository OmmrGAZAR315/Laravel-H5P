        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-primary">
                    ...
                    <form action="{{ route('h5p.library.store') }}" id="h5p-library-form" class="form-horizontal"
                        enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="panel-body">

                            <div class="form-group {{ $errors->has('h5p_file') ? 'has-error' : '' }}"
                                style="margin-bottom: 0px;">
                                <label for="inputTitle"
                                    class="control-label col-md-3">{{ trans('laravel-h5p.library.upload_libraries') }}</label>
                                <div class="col-md-9">
                                    ...
                                    <ul class="list-unstyled" style="margin:10px 0px 0px;">
                                        ...
                                        <li> <label for="h5p-disable-file-check" class="">
                                                <input type="checkbox" name="h5p_disable_file_check"
            ...
            <div class="col-md-3">
                <div class="panel panel-primary">
                    ...
                    <form action="{{ route('h5p.library.clear') }}" id="laravel-h5p-update-content-type-cache"
                        ...
                        <div class="panel-footer">
                            ...
                            <input type="submit" name="updatecache" id="updatecache" class="btn btn-danger btn-large"
                ...
                <table class="table text-middle text-center h5p-lists">
                    ...
                    <tbody>
                        ...
                        @unless(count($entrys) > 0)
                            <tr>
                                <td colspan="6" class="h5p-noresult">{{ trans('laravel-h5p.common.no-result') }}</td>
                            </tr>
                        @endunless
                        ...
                        @foreach($entrys as $entry)
                            <tr>
                                ...
                                <td class="text-center">
                                    <p class="form-control-static">
                                        {{ $entry->major_version . '.' . $entry->minor_version . '.' . $entry->patch_version }}</p>
                                </td>

                                <td class="text-center">

                                    <input type="checkbox" value="{{ $entry->restricted }}" @if($entry->restricted == '1')
                                    checked="" @endif class="laravel-h5p-restricted" data-id="{{ $entry->id }}">
                                ...
                                <td class="text-center">
                                    <p class="form-control-static">{{ number_format($entry->getCountContentDependencies()) }}
                                    </p>
                                </td>
                                <td class="text-center">
                                    <p class="form-control-static">{{ number_format($entry->getCountLibraryDependencies()) }}
                                    </p>
                                </td>

                                <td class="text-center">
                                    <button class="btn btn-danger laravel-h5p-destory"
