    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('h5p.store') }}" class="form-horizontal" enctype="multipart/form-data"
                    id="laravel-h5p-form" method="POST">
                    @csrf
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="title" value="{{ old('title') }}" class="form-control"
                                    placeholder="{{ trans('laravel-h5p.content.title') }}" id="laravel-h5p-title">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-control-static">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                <label>
                                                    <input type="checkbox" name="frame" value="1" {{ $display_options[H5PCore::DISPLAY_OPTION_FRAME] ? 'checked' : '' }}
                                            ...
                                            @if(isset($display_options[H5PCore::DISPLAY_OPTION_DOWNLOAD]))
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="download" value="1" {{ $display_options[H5PCore::DISPLAY_OPTION_DOWNLOAD] ? 'checked' : '' }}
                                                            class="h5p-visibility-toggler"
                                                            data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                            ...
                                            @if (isset($display_options[H5PCore::DISPLAY_OPTION_EMBED]))
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="embed" value="1" {{ $display_options[H5PCore::DISPLAY_OPTION_EMBED] ? 'checked' : '' }}
                                                            class="h5p-visibility-toggler"
                                                            data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                            ...
                                            @if  (isset($display_options[H5PCore::DISPLAY_OPTION_COPYRIGHT]))
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="copyright" value="1" {{ $display_options[H5PCore::DISPLAY_OPTION_COPYRIGHT] ? 'checked' : '' }}
                                                            class="h5p-visibility-toggler"
                                                            data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
